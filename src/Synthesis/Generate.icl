...
harmonicsAmplitudes :: Wave -> ([Real], [Real])
harmonicsAmplitudes Sine = ([1.0], [1.0])
harmonicsAmplitudes Sawtooth = ([1.0,2.0..50.0],[ (-1.0)^(k+1.0) * (1.0 / k) \\ k <- [1.0,2.0..50.0]])
harmonicsAmplitudes Square = ([1.0,3.0..100.0], [1.0 / x \\ x <- [1.0,3.0..100.0]])
harmonicsAmplitudes Triangle = ([1.0,3.0..100.0], [ (-1.0)^(i + 1.0) * (1.0/(k^2.0)) \\ k <- [1.0,3.0..100.0] & i <- [1.0..] ])
...
where
    (harmonics, amplitudes) = harmonicsAmplitudes wavetype
